...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "ayaangazali.work@gmail",
    href: "mailto:ayaangazali.work@gmail.com",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "Phone",
    content: "(669) 360-9914",
    href: "tel:6693609914",
    icon: <FaPhone height={"50px"} />,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/ayaangazali",
    content: "/ayaangazali",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/ayaangazali",
    content: "/ayaangazali",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Ayaan Gazali</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Ayaan, a Computer Software Engineering student at 
              San José State University and a 10x hackathon winner at Microsoft, NVIDIA, 
              AWS, and more. I&apos;m passionate about building innovative AI-powered 
              solutions and full-stack applications that solve real-world problems. 
              My journey began with a fascination for technology and a drive to make a 
              positive impact through code.
            </p>
            <p className="mb-10">
              When I&apos;m not coding, you can find me exploring new AI/ML technologies, 
              competing in hackathons, or working on side projects that push the boundaries 
