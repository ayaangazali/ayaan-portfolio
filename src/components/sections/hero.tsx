            ...
            <div className="flex flex-col">
              <div>
                ...
                <BlurIn delay={1.4}>
                  <p
                    className={cn(
                      "md:self-start mt-2 font-thin text-sm text-slate-400 dark:text-zinc-500",
                      "cursor-default font-display sm:text-base md:text-base bg-clip-text "
                    )}
                  >
                    10x Hackathon Winner 🏆 Microsoft • NVIDIA • AWS
                  </p>
                </BlurIn>
              </div>
              <div className="mt-8 flex flex-col gap-3 w-fit">
                <Link
                  href={
                    "https://drive.google.com/file/d/1VAEnYcKqctdJ6QC2rPqaAL6sTPjNlHoH/view?usp=sharing"
                  }
                  target="_blank"
                  className="flex-1"
                >
